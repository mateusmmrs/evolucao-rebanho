...
> **Nota metodológica:** Correlações de Pearson e Spearman foram calculadas no nível estadual agregado. Dados de série temporal com 20 anos por unidade podem apresentar autocorrelação serial, o que não foi formalmente testado nesta versão.
...
python scripts/01_coleta_e_limpeza.py     # coleta + limpeza
python scripts/02_analise_exploratoria.py  # EDA
python scripts/03_correlacoes_e_conclusoes.py  # correlações
```
